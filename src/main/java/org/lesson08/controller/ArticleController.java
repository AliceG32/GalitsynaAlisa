...
import org.lesson08.controller.request.ArticleCreateRequest;
import org.lesson08.controller.request.ArticleUpdateRequest;
import org.lesson08.controller.response.*;
        ...
        service.get(
                ...
                (Request request, Response response) -> {
                    try {
                        ...
                        List<Comment> comments = commentService.findAllByArticleId(article.getId());
